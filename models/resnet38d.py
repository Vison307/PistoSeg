...
class ResBlock(nn.Module):
    ...
    def forward(self, x, get_x_bn_relu=False):
        ...
        x_bn_relu = branch2 # [N, in_channels, H, W]

        if not self.same_shape:
            branch1 = self.conv_branch1(branch2) # [N, out_channels, H // stride, W // stride]
        else:
            branch1 = x
...
class ResBlock_bot(nn.Module):
    ...
    def forward(self, x, get_x_bn_relu=False):
        ...
        x = branch1 + branch2 # skip connection
